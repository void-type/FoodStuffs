...
public class SaveRecipeRequestValidatorTests
{
    ...
    {
        var recipe = new SaveRecipeRequest(0, "null", directions!, string.Empty, 10, 10, false, 2, [], []);
    ...
    {
        var recipe = new SaveRecipeRequest(0, recipeName!, "null", string.Empty, 10, 10, false, 2, [], []);
        var validator = new SaveRecipeRequestValidator();
        var result = validator.Validate(recipe);
    ...
    {
        var recipe = new SaveRecipeRequest(0, "null", "null", string.Empty, time, 10, false, 2, [], []);
        var validator = new SaveRecipeRequestValidator();
        var result = validator.Validate(recipe);
