...
public class SaveRecipeRequestValidatorTests
{
    ...
    {
        var recipe = new SaveRecipeRequest(0, "null", directions, 10, 10, false, [], [], []);
    ...
    {
        var recipe = new SaveRecipeRequest(0, "null", "null", 10, 10, false, [new SaveRecipeRequestIngredient(ingredients, 2, 1, false)], [], []);
        var validator = new SaveRecipeRequestValidator();
        var result = validator.Validate(recipe);
    ...
    {
        var recipe = new SaveRecipeRequest(0, "null", "null", 10, 10, false, [new SaveRecipeRequestIngredient(ingredients, 1, 2, false)], [], []);
        var validator = new SaveRecipeRequestValidator();
        var result = validator.Validate(recipe);
    ...
    {
        var recipe = new SaveRecipeRequest(0, recipeName, "null", 10, 10, false, [], [], []);
        var validator = new SaveRecipeRequestValidator();
        var result = validator.Validate(recipe);
    ...
    {
        var recipe = new SaveRecipeRequest(0, "null", "null", time, 10, false, [], [], []);
        var validator = new SaveRecipeRequestValidator();
        var result = validator.Validate(recipe);
    ...
    {
        var recipe = new SaveRecipeRequest(0, "null", "null", 10, time, false, [], [], []);
        var validator = new SaveRecipeRequestValidator();
        var result = validator.Validate(recipe);
    ...
    {
        var recipe = new SaveRecipeRequest(0, testString, testString, null, null, false, [new SaveRecipeRequestIngredient(testString, 12, 1, false)], [], null);
        var validator = new SaveRecipeRequestValidator();
        var result = validator.Validate(recipe);
