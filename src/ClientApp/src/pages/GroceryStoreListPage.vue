  ...
  <div class="container-xxl">
    ...
    <div class="mt-3">
      ...
      <div class="btn-toolbar">
        ...
        <router-link :to="{ name: 'groceryStoreNew' }" class="btn btn-secondary">
          New
        </router-link>
      </div>
    </div>
    ...
    >
      ...
      <tbody>
        <tr v-for="groceryStore in listResponse.items" :key="groceryStore.id">
          <td>
            <router-link :to="{ name: 'groceryStoreEdit', params: { id: groceryStore.id } }">
              {{ groceryStore.name }}
            </router-link>
          </td>
