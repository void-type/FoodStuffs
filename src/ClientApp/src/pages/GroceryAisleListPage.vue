  ...
  <div class="container-xxl">
    ...
    <div class="mt-3">
      ...
      <div class="btn-toolbar">
        ...
        <router-link :to="{ name: 'groceryAisleNew' }" class="btn btn-secondary" data-test-id="new-button">
          New
        </router-link>
      </div>
    </div>
    ...
    >
      ...
      <tbody>
        <tr v-for="groceryAisle in listResponse.items" :key="groceryAisle.id" :data-test-id="`entity-row-${groceryAisle.id}`">
          <td>
            <router-link :to="{ name: 'groceryAisleEdit', params: { id: groceryAisle.id } }" :data-test-id="`entity-name-${groceryAisle.id}`">
              {{ groceryAisle.name }}
            </router-link>
          </td>
          ...
          <td>
            <button
              ...
              :data-test-id="`entity-delete-${groceryAisle.id}`"
