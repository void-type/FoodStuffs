...
namespace FoodStuffs.Model.Migrations
{
    ...
    [Migration("20260313035121_AddGroceryStore")]
    partial class AddGroceryStore
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodStuffs.Model.Data.Models.GroceryStore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("GroceryStore", (string)null);
                });
            ...
            modelBuilder.Entity("GroceryItemGroceryStoreRelation", b =>
                {
                    b.Property<int>("GroceryItemId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("GroceryItemId", "GroceryStoreId");

                    b.HasIndex("GroceryStoreId");

                    b.ToTable("GroceryItemGroceryStoreRelation");
                });
            ...
            modelBuilder.Entity("GroceryItemGroceryStoreRelation", b =>
                {
                    ...
                    b.HasOne("FoodStuffs.Model.Data.Models.GroceryStore", null)
                        .WithMany()
