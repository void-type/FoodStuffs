...
namespace FoodStuffs.Test.Mocks
{
    ...
    {
        public static IDateTimeService EarlyDateTimeService => new DiscreteDateTimeService(new DateTime(2001, 1, 1, 11, 11, 11));
        public static IDateTimeService LateDateTimeService => new DiscreteDateTimeService(new DateTime(2002, 2, 2, 22, 22, 22));
